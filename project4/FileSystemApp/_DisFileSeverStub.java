...
/**
* FileSystemApp/_DisFileSeverStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from DisFileAPP.idl
* Monday, December 7, 2020 4:33:59 AM EST
*/

public class _DisFileSeverStub extends org.omg.CORBA.portable.ObjectImpl implements FileSystemApp.DisFileSever
{
  ...
  public boolean writeToFile (String title, String contents)
  {
            ...
            try {
                ...
                return writeToFile (title, contents        );
            } finally {
                _releaseReply ($in);
            }
  } // writeToFile
  ...
  public boolean unlockForWrite (String title)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("unlockForWrite", true);
                $out.write_string (title);
                $in = _invoke ($out);
                boolean $result = $in.read_boolean ();
                return $result;
  ...
  public String lookForFile (String title)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("lookForFile", true);
                $out.write_string (title);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                return $result;
